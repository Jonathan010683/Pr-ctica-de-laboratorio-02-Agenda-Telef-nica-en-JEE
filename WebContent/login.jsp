	...
	<div class="row">
		<div class="col">
			<div class="row banner">
				<div class="col my-3">
					<a class="btn btn-light d-block mx-auto float-right" style="width: 15%;"
			...
			<form class="container form-group" action="/pruebaPagina02/iniciar-sesion" method="post" >
				...
				<h3 class="text-light text-center mt-3">Inicio de sesión</h3>
                ...
                <button class="form-control text-center btn-primary mx-auto mt-3 mb-5"
                    id="ingresar" style="width:20%" type="submit">Ingresar
                </button>
			</form>
		</div>
	</div>
